...
def process_folder(recognitor, detector, folder_path, output_dir, input_root):
    ...
    # Remove duplicate folder (assume second occurrence is duplicate)
...
def main():
    ...
    for i, folder_path in enumerate(image_folders, 1):
        ...
        try:
            process_folder(recognitor, detector, folder_path, args.output_dir, args.input_dir)
        except Exception as e:
